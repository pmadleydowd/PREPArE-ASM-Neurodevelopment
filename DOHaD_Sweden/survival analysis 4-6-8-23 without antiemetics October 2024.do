...
count
	...
	stpm3 ib10.super_exposure $main_confounders, df(4) scale(lncumhazard) eform
	est store stpm3_`var'

 }
	 
	 estout stpm3* using output_without_a04.xls, keep(*.super_exposure)  cells("b(fmt(5)) se(fmt(5)) ci(fmt(5))") label replace
